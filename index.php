	...
	<form action="realiza_inscricao.php" method="POST" class="container">
		...
		<div class="row">
			...
			<fieldset class="form-group col-xs-12 col-md-4">
				...
				<div class="form-check">
					<input type="radio" class="form-check-input" name="estado_civil" id="radioSolteiro">
					<label value="so" class="form-check-label" for="radioSolteiro">Solteiro</label>
				</div>
				<div class="form-check">
					<input type="radio" class="form-check-input" name="estado_civil" id="radioCasado">
					<label value="ca" class="form-check-label" for="radioCasado">Casado</label>
				</div>
				<div class="form-check">
					<input type="radio" class="form-check-input" name="estado_civil" id="radioUE">
					<label value="ue" class="form-check-label" for="radioUE">União Estável</label>
				</div>
			</fieldset>
